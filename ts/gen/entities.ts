...
export const entities = [ApiKey, Audit, Binding, Credential, Email, Group, GroupMembership, Holder, Identity, Outbox, Role, Site, SiteMembership, Team, TeamMembership, Tenant] as const
