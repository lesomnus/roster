...
export const file_app_apikey_svc_g: GenFile = /*@__PURE__*/
  fileDesc("", [file_app_apikey, file_google_protobuf_timestamp, file_patch_patch, file_roster_payday_holder_svc_g]);
...
export type ApiKeyRef = Message<"roster.ApiKeyRef"> & {
  ...
  key: {
    ...
    /**
     * @generated from field: roster.ApiKeyRefBySlug slug = 4;
     */
    value: ApiKeyRefBySlug;
    case: "slug";
  } | {
    /**
...
/**
 * @generated from message roster.ApiKeyRefBySlug
 */
export type ApiKeyRefBySlug = Message<"roster.ApiKeyRefBySlug"> & {
  /**
...
/**
 * Describes the message roster.ApiKeyRefBySlug.
 * Use `create(ApiKeyRefBySlugSchema)` to create a new message.
 */
export const ApiKeyRefBySlugSchema: GenMessage<ApiKeyRefBySlug> = /*@__PURE__*/
...
export type ApiKeyIssueRequest = Message<"roster.ApiKeyIssueRequest"> & {
   ...
   * refused.
   *
   * @generated from field: string holder_alias = 1 [features.field_presence = IMPLICIT];
   */
  holderAlias: string;
