...
func TestBaselineNamesRealTests(t *testing.T) {
	...
	var files []string
	for _, dir := range []string{".", filepath.Join("..", "account"), filepath.Join("..", "frontdoor"), filepath.Join("..", "wasm", "sandbox"), filepath.Join("..", "ldap"), filepath.Join("..", "ldap", "wire"), filepath.Join("..", "login")} {
