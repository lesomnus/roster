...
func (_q *HostQuery) QueryTenant() *TenantQuery {
...
// All executes the query and returns a list of Host entities.
...
func (_q *HostQuery) Ids(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	var nodes []*Host
	if nodes, err = _q.Select(host.FieldId).All(ctx); err != nil {
		return nil, err
	}
...
func (_q *HostQuery) WithTenant(opts ...func(*TenantQuery)) *HostQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *HostQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Host, error) {
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *Host, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *HostQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Host, init func(*Host), assign func(*Host, *Tenant)) error {
