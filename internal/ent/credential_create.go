...
func (_c *CredentialCreate) sqlSave(ctx context.Context) (*Credential, error) {
	...
	if _spec.Id.Value != nil {
		...
		if !ok {
			sv = credential.ValueScanner.Id.ScanValue()
			if err := sv.Scan(_spec.Id.Value); err != nil {
				return nil, err
			}
		}
		if value, err := credential.ValueScanner.Id.FromValue(sv); err != nil {
			return nil, err
		} else {
			_node.Id = value
		}
...
func (_c *CredentialCreate) createSpec() (*Credential, *sqlgraph.CreateSpec, error) {
	var (
		...
		func(i int, root context.Context) {
			...
			var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
				...
				if specs[i].Id.Value != nil {
					...
					if id, err := credential.ValueScanner.Id.FromValue(sv); err != nil {
						return nil, err
					} else {
						nodes[i].Id = id
					}
