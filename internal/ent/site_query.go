...
// All executes the query and returns a list of Site entities.
...
func (_q *SiteQuery) Ids(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	var nodes []*Site
	if nodes, err = _q.Select(site.FieldId).All(ctx); err != nil {
		return nil, err
	}
