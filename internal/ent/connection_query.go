...
func (_q *ConnectionQuery) QueryTenant() *TenantQuery {
...
// All executes the query and returns a list of Connection entities.
...
func (_q *ConnectionQuery) Ids(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	if nodes, err = _q.Select(connection.FieldId).All(ctx); err != nil {
		return nil, err
	}
...
func (_q *ConnectionQuery) WithTenant(opts ...func(*TenantQuery)) *ConnectionQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *ConnectionQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Connection, init func(*Connection), assign func(*Connection, *Tenant)) error {
...
func (_q *ConnectionQuery) Modify(modifiers ...func(s *sql.Selector)) *ConnectionSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *ConnectionSelect) Modify(modifiers ...func(s *sql.Selector)) *ConnectionSelect {
