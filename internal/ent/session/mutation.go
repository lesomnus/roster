...
func (m *Mutation) SetGrant(b []byte) {
	m.grant = &b
}

// Grant returns the value of the "grant" field in the mutation.
func (m *Mutation) Grant() (r []byte, exists bool) {
	v := m.grant
	if v == nil {
		return
	}
...
func (m *Mutation) SetDateIdle(t time.Time) {
	m.date_idle = &t
}

// DateIdle returns the value of the "date_idle" field in the mutation.
func (m *Mutation) DateIdle() (r time.Time, exists bool) {
	v := m.date_idle
	if v == nil {
		return
	}
...
func (m *Mutation) ClearDateIdle() {
	m.date_idle = nil
	m.clearedFields[FieldDateIdle] = struct{}{}
}

// DateIdleCleared returns if the "date_idle" field was cleared in this mutation.
func (m *Mutation) DateIdleCleared() bool {
	_, ok := m.clearedFields[FieldDateIdle]
	return ok
}

// ResetDateIdle resets all changes to the "date_idle" field.
func (m *Mutation) ResetDateIdle() {
	m.date_idle = nil
	delete(m.clearedFields, FieldDateIdle)
}
...
func (m *Mutation) Fields() []string {
	...
	if m.grant != nil {
		fields = append(fields, FieldGrant)
	}
	if m.secret != nil {
	...
	if m.date_idle != nil {
		fields = append(fields, FieldDateIdle)
	}
...
func (m *Mutation) ClearedFields() []string {
	...
	if m.FieldCleared(FieldDateIdle) {
		fields = append(fields, FieldDateIdle)
	}
