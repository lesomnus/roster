...
// Mutation represents an operation that mutates the Delegation nodes in the graph.
...
// NewMutation creates a new Mutation for the Delegation entity.
...
func (m *Mutation) Predicates() []predicate.Delegation {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.Delegation) {
