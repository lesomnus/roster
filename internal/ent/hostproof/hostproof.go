...
const (
	// Label holds the string label denoting the hostproof type in the database.
	Label = "host_proof"
	...
	EdgeTenant = "tenant"
	// Table holds the table name of the hostproof in the database.
	Table = "hostproof"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "hostproof"
...
// Columns holds all SQL columns for hostproof fields.
var Columns = []string{
	FieldId,
	FieldName,
	FieldToken,
...
// OrderOption defines the ordering options for the HostProof queries.
