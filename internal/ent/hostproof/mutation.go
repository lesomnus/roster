...
// Mutation represents an operation that mutates the HostProof nodes in the graph.
...
// NewMutation creates a new Mutation for the HostProof entity.
...
func (m *Mutation) Predicates() []predicate.HostProof {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.HostProof) {
...
func (m *Mutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.HostProof, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Type returns the node type of this mutation (HostProof).
...
func (m *Mutation) SetField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown HostProof field %s", name)
}
...
func (m *Mutation) AddField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown HostProof numeric field %s", name)
}
...
func (m *Mutation) ClearField(name string) error {
	...
	return fmt.Errorf("unknown HostProof nullable field %s", name)
}
...
func (m *Mutation) ClearEdge(name string) error {
	...
	return fmt.Errorf("unknown HostProof unique edge %s", name)
}
...
func (m *Mutation) ResetEdge(name string) error {
	...
	return fmt.Errorf("unknown HostProof edge %s", name)
}
