...
func (_c *BindingCreate) sqlSave(ctx context.Context) (*Binding, error) {
	...
	if _spec.Id.Value != nil {
		...
		if !ok {
			sv = binding.ValueScanner.Id.ScanValue()
			if err := sv.Scan(_spec.Id.Value); err != nil {
				return nil, err
			}
		}
		if value, err := binding.ValueScanner.Id.FromValue(sv); err != nil {
			return nil, err
		} else {
			_node.Id = value
		}
...
func (_c *BindingCreate) createSpec() (*Binding, *sqlgraph.CreateSpec, error) {
	var (
		...
		func(i int, root context.Context) {
			...
			var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
				...
				if specs[i].Id.Value != nil {
					...
					if id, err := binding.ValueScanner.Id.FromValue(sv); err != nil {
						return nil, err
					} else {
						nodes[i].Id = id
					}
