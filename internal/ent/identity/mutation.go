...
// Mutation represents an operation that mutates the Identity nodes in the graph.
...
// NewMutation creates a new Mutation for the Identity entity.
...
func (m *Mutation) Predicates() []predicate.Identity {
	return m.predicates
}
...
func (m *Mutation) Where(ps ...predicate.Identity) {
