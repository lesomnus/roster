...
func (_q *LinkQuery) QueryHolder() *HolderQuery {
...
func (_q *LinkQuery) Ids(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	var nodes []*Link
	if nodes, err = _q.Select(link.FieldId).All(ctx); err != nil {
		return nil, err
	}
...
func (_q *LinkQuery) WithHolder(opts ...func(*HolderQuery)) *LinkQuery {
	query := (&HolderClient{config: _q.config}).Query()
...
func (_q *LinkQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Link, error) {
	...
	if query := _q.withHolder; query != nil {
		if err := _q.loadHolder(ctx, query, nodes, nil,
			func(n *Link, e *Holder) { n.Edges.Holder = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *LinkQuery) loadHolder(ctx context.Context, query *HolderQuery, nodes []*Link, init func(*Link), assign func(*Link, *Holder)) error {
