...
func (_q *DelegationQuery) QueryHolder() *HolderQuery {
...
// All executes the query and returns a list of Delegation entities.
...
func (_q *DelegationQuery) Ids(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	var nodes []*Delegation
	if nodes, err = _q.Select(delegation.FieldId).All(ctx); err != nil {
		return nil, err
	}
...
func (_q *DelegationQuery) WithHolder(opts ...func(*HolderQuery)) *DelegationQuery {
	query := (&HolderClient{config: _q.config}).Query()
...
//		GroupBy(delegation.FieldMethods).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Delegation.Query().
//		Select(delegation.FieldMethods).
//		Scan(ctx, &v)
...
func (_q *DelegationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Delegation, error) {
	...
	if query := _q.withHolder; query != nil {
		if err := _q.loadHolder(ctx, query, nodes, nil,
			func(n *Delegation, e *Holder) { n.Edges.Holder = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DelegationQuery) loadHolder(ctx context.Context, query *HolderQuery, nodes []*Delegation, init func(*Delegation), assign func(*Delegation, *Holder)) error {
...
func (_q *DelegationQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withHolder != nil {
			_spec.Node.AddColumnOnce(delegation.FieldHolderId)
		}
	}
...
func (_q *DelegationQuery) Modify(modifiers ...func(s *sql.Selector)) *DelegationSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *DelegationSelect) Modify(modifiers ...func(s *sql.Selector)) *DelegationSelect {
