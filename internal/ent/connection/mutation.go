...
// Mutation represents an operation that mutates the Connection nodes in the graph.
...
// NewMutation creates a new Mutation for the Connection entity.
...
func (m *Mutation) Predicates() []predicate.Connection {
	return m.predicates
}
...
func (m *Mutation) SetIssuer(s string) {
	m.issuer = &s
}

// Issuer returns the value of the "issuer" field in the mutation.
func (m *Mutation) Issuer() (r string, exists bool) {
	v := m.issuer
	if v == nil {
		return
	}
...
func (m *Mutation) SetScopes(s []string) {
	m.scopes = &s
	m.appendscopes = nil
}

// Scopes returns the value of the "scopes" field in the mutation.
func (m *Mutation) Scopes() (r []string, exists bool) {
	v := m.scopes
	if v == nil {
		return
	}
...
func (m *Mutation) AppendScopes(s []string) {
	m.appendscopes = append(m.appendscopes, s...)
}

// AppendedScopes returns the list of values that were appended to the "scopes" field in this mutation.
func (m *Mutation) AppendedScopes() ([]string, bool) {
...
func (m *Mutation) ClearScopes() {
	m.scopes = nil
	m.appendscopes = nil
	m.clearedFields[FieldScopes] = struct{}{}
}

// ScopesCleared returns if the "scopes" field was cleared in this mutation.
func (m *Mutation) ScopesCleared() bool {
	_, ok := m.clearedFields[FieldScopes]
	return ok
}

// ResetScopes resets all changes to the "scopes" field.
func (m *Mutation) ResetScopes() {
	m.scopes = nil
	m.appendscopes = nil
	delete(m.clearedFields, FieldScopes)
}

// SetSecretRef sets the "secret_ref" field.
func (m *Mutation) SetSecretRef(s string) {
	m.secret_ref = &s
}

// SecretRef returns the value of the "secret_ref" field in the mutation.
func (m *Mutation) SecretRef() (r string, exists bool) {
	v := m.secret_ref
	if v == nil {
		return
	}
...
func (m *Mutation) ResetSecretRef() {
	m.secret_ref = nil
}
...
func (m *Mutation) Where(ps ...predicate.Connection) {
