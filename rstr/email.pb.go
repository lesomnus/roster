...
const file_app_email_proto_rawDesc = "" +
	"\n" +
	"\x0fapp/email.proto\x12\x06roster\x1a\x12app/identity.proto\x1a\x1aroster/payday/holder.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\torm.proto\x1a\fpayday.proto\"\xd5\x04\n" +
	"\x05Email\x12\x1b\n" +
	...
	"dateErased\x12H\n" +
	"\fdate_created\x18\x0f \x01(\v2\x1a.google.protobuf.TimestampB\t\xea\x82\x16\x05@\x01\x82\x01\x00R\vdateCreated:\x8a\x01\xca\xfc\x15L\x12\x02\x10\x01\x1a \x12\x04page\x1a\x10\n" +
	"\fdate_created\x10\x0f\x1a\x06\n" +
	"\x02id\x10\x01\x1a$\x12\aaddress\x1a\n" +
	"\n" +
	"\x06holder\x10\x02\x1a\v\n" +
	"\aaddress\x10\b0\x01\x8a\xbb\x166\b\t2\x1f\n" +
	"\x0e\n" +
	"\fdate_created\n" +
	"\x04\n" +
