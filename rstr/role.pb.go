...
type Role_builder struct {
	...
	Name  string
	Desc  string
	// The RPCs this allows, in full: "/roster.HolderService/Get".
	//
...
const file_app_role_proto_rawDesc = "" +
	"\n" +
	"\x0eapp/role.proto\x12\x06roster\x1a\x1aroster/payday/tenant.proto\x1a\x1aroster/payday/holder.proto\x1a\x0eapp/site.proto\x1a\x0fapp/group.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\torm.proto\x1a\fpayday.proto\"\xa4\x04\n" +
	"\x04Role\x12\x1b\n" +
	...
	"dateErased\x12H\n" +
	"\fdate_created\x18\x0f \x01(\v2\x1a.google.protobuf.TimestampB\t\xea\x82\x16\x05@\x01\x82\x01\x00R\vdateCreated:s\xca\xfc\x15H\x12\x02\x10\x01\x1a \x12\x04page\x1a\x10\n" +
	"\fdate_created\x10\x0f\x1a\x06\n" +
	"\x02id\x10\x01\x1a \x12\x05alias\x1a\n" +
	"\n" +
	"\x06tenant\x10\x02\x1a\t\n" +
	"\x05alias\x10\x040\x01\x8a\xbb\x16#\b\x0f2\x1f\n" +
	"\x0e\n" +
	"\fdate_created\n" +
	"\x04\n" +
	"\x02id\x1a\x03ref \x14(d\"\x97\x04\n" +
	"\aBinding\x12\x1b\n" +
	"\x02id\x18\x01 \x01(\fB\v\xea\x82\x16\a\x10@(\x01\x82\x01\x00R\x02id\x12(\n" +
	...
	"\vdate_erased\x18\x0e \x01(\v2\x1a.google.protobuf.TimestampB\a\xea\x82\x16\x03\x92\x01\x00R\n" +
	"dateErased\x12H\n" +
	"\fdate_created\x18\x0f \x01(\v2\x1a.google.protobuf.TimestampB\t\xea\x82\x16\x05@\x01\x82\x01\x00R\vdateCreated:`\xca\xfc\x15&\x12\x02\x10\x01\x1a \x12\x04page\x1a\x10\n" +
	"\fdate_created\x10\x0f\x1a\x06\n" +
	"\x02id\x10\x01\x8a\xbb\x162\b\x122\x1f\n" +
	"\x0e\n" +
	"\fdate_created\n" +
	"\x04\n" +
	"\x02id\x1a\x03ref \x14(d\"\r\n" +
