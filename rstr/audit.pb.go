...
func (x *Audit) Reset() {
	*x = Audit{}
	mi := &file_roster_payday_audit_proto_msgTypes[0]
...
var File_roster_payday_audit_proto protoreflect.FileDescriptor
...
var file_roster_payday_audit_proto_depIdxs = []int32{
...
func init() { file_roster_payday_audit_proto_init() }
func file_roster_payday_audit_proto_init() {
	if File_roster_payday_audit_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_roster_payday_audit_proto_rawDesc), len(file_roster_payday_audit_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_roster_payday_audit_proto_goTypes,
		DependencyIndexes: file_roster_payday_audit_proto_depIdxs,
		MessageInfos:      file_roster_payday_audit_proto_msgTypes,
	}.Build()
	File_roster_payday_audit_proto = out.File
	file_roster_payday_audit_proto_goTypes = nil
	file_roster_payday_audit_proto_depIdxs = nil
}
