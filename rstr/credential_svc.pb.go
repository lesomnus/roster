...
type CredentialEnrolRequest struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Ref         *HolderRef             `protobuf:"bytes,1,opt,name=ref"`
	xxx_hidden_Kind        string                 `protobuf:"bytes,2,opt,name=kind"`
	xxx_hidden_Name        string                 `protobuf:"bytes,3,opt,name=name"`
	xxx_hidden_Issuer      string                 `protobuf:"bytes,4,opt,name=issuer"`
	xxx_hidden_Attestation []byte                 `protobuf:"bytes,5,opt,name=attestation"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *CredentialEnrolRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CredentialEnrolRequest) GetRef() *HolderRef {
	if x != nil {
		return x.xxx_hidden_Ref
	}
	return nil
...
func (x *CredentialEnrolRequest) GetKind() string {
	if x != nil {
		return x.xxx_hidden_Kind
	}
	return ""
...
func (x *CredentialEnrolRequest) GetName() string {
	if x != nil {
		return x.xxx_hidden_Name
	}
	return ""
...
func (x *CredentialEnrolRequest) GetIssuer() string {
	if x != nil {
...
func (x *CredentialEnrolRequest) GetAttestation() []byte {
	if x != nil {
...
func (x *CredentialEnrolRequest) SetRef(v *HolderRef) {
	x.xxx_hidden_Ref = v
}

func (x *CredentialEnrolRequest) SetKind(v string) {
	x.xxx_hidden_Kind = v
}

func (x *CredentialEnrolRequest) SetName(v string) {
	x.xxx_hidden_Name = v
}

func (x *CredentialEnrolRequest) SetIssuer(v string) {
	x.xxx_hidden_Issuer = v
}

func (x *CredentialEnrolRequest) SetAttestation(v []byte) {
	if v == nil {
		v = []byte{}
	}
...
func (x *CredentialEnrolRequest) HasRef() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_Ref != nil
...
func (x *CredentialEnrolRequest) HasAttestation() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 4)
...
func (x *CredentialEnrolRequest) ClearRef() {
	x.xxx_hidden_Ref = nil
}

func (x *CredentialEnrolRequest) ClearAttestation() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 4)
	x.xxx_hidden_Attestation = nil
}

type CredentialEnrolRequest_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 CredentialEnrolRequest_builder) Build() *CredentialEnrolRequest {
	m0 := &CredentialEnrolRequest{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_Ref = b.Ref
	x.xxx_hidden_Kind = b.Kind
...
type CredentialEnrolResponse struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
...
func (x *CredentialEnrolResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CredentialEnrolResponse) GetSeed() string {
	if x != nil {
...
func (x *CredentialEnrolResponse) GetUri() string {
	if x != nil {
...
func (x *CredentialEnrolResponse) SetSeed(v string) {
	x.xxx_hidden_Seed = v
}

func (x *CredentialEnrolResponse) SetUri(v string) {
	x.xxx_hidden_Uri = v
}

type CredentialEnrolResponse_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 CredentialEnrolResponse_builder) Build() *CredentialEnrolResponse {
	m0 := &CredentialEnrolResponse{}
	b, x := &b0, m0
	_, _ = b, x
...
const file_app_credential_svc_g_proto_rawDesc = "" +
	...
	"\x03ref\x18\x01 \x01(\v2\x11.roster.HolderRefR\x03ref\x12\x19\n" +
	"\x04kind\x18\x02 \x01(\tB\x05\xaa\x01\x02\b\x02R\x04kind\x12\x19\n" +
	"\x04name\x18\x03 \x01(\tB\x05\xaa\x01\x02\b\x02R\x04name\x12\x1d\n" +
	"\x06issuer\x18\x04 \x01(\tB\x05\xaa\x01\x02\b\x02R\x06issuer\x12 \n" +
	...
	"\x03uri\x18\x02 \x01(\tB\x05\xaa\x01\x02\b\x02R\x03uri2\x87\x06\n" +
...
var file_app_credential_svc_g_proto_goTypes = []any{
	...
	(*CredentialEnrolRequest)(nil),       // 20: roster.CredentialEnrolRequest
	(*CredentialEnrolResponse)(nil),      // 21: roster.CredentialEnrolResponse
...
var file_app_credential_svc_g_proto_depIdxs = []int32{
	...
	16, // 34: roster.CredentialService.Unlock:input_type -> roster.CredentialUnlockRequest
	18, // 35: roster.CredentialService.Set:input_type -> roster.CredentialSetRequest
	20, // 36: roster.CredentialService.Enrol:input_type -> roster.CredentialEnrolRequest
	26, // 37: roster.CredentialService.Add:output_type -> roster.Credential
	26, // 38: roster.CredentialService.Get:output_type -> roster.Credential
	26, // 39: roster.CredentialService.Patch:output_type -> roster.Credential
	26, // 40: roster.CredentialService.Apply:output_type -> roster.Credential
	7,  // 41: roster.CredentialService.Erase:output_type -> roster.CredentialEraseResponse
	9,  // 42: roster.CredentialService.List:output_type -> roster.CredentialListResponse
	12, // 43: roster.CredentialService.Watch:output_type -> roster.CredentialWatchResponse
	15, // 44: roster.CredentialService.ChangeMine:output_type -> roster.CredentialChangeMineResponse
	17, // 45: roster.CredentialService.Unlock:output_type -> roster.CredentialUnlockResponse
	19, // 46: roster.CredentialService.Set:output_type -> roster.CredentialSetResponse
	21, // 47: roster.CredentialService.Enrol:output_type -> roster.CredentialEnrolResponse
