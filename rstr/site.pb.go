...
const file_app_site_proto_rawDesc = "" +
	"\n" +
	"\x0eapp/site.proto\x12\x06roster\x1a\x1aroster/payday/tenant.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\torm.proto\x1a\fpayday.proto\"\xe1\x04\n" +
	"\x04Site\x12\x1b\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\x88\x01\xca\xfc\x15G\x12\x02\x10\x01\x1a \x12\x04page\x1a\x10\n" +
	"\fdate_created\x10\x0f\x1a\x06\n" +
	"\x02id\x10\x01\x1a\x1f\x12\x04slug\x1a\t\n" +
	"\x05alias\x10\x04\x1a\n" +
	"\n" +
	"\x06tenant\x10\x020\x01\x8a\xbb\x169\b\a23\n" +
	"\x12\n" +
	"\x10\n" +
	...
	"\x03ref\x1a\b\n" +
	"\x06tenant \x14(d:\x00B&Z\x1fgithub.com/lesomnus/roster/rstr\x92\x03\x02\b\x02b\beditionsp\xe8\a"
