...
| P7 | two-step verification | **in progress** — increments 1 and 2 done (PLAN.md D29): per-kind verification, the wrapped seed, replay, and `Vouch.Enrol`. Left: the continuation, and the app's half-session |
